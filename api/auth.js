      ...
      <div style="font-family:Inter,sans-serif;max-width:520px;margin:0 auto;background:#05060E;color:#E8EAF2;border-radius:12px;overflow:hidden">
        ...
        <div style="padding:24px 28px">
          <table style="width:100%;border-collapse:collapse;font-size:14px">
            <tr><td style="padding:8px 0;color:#8B8FA8;width:130px">Name</td><td style="padding:8px 0;font-weight:600;color:#E8EAF2">${name || '—'}</td></tr>
            ...
            <tr><td style="padding:8px 0;color:#8B8FA8">Signed in via</td><td style="padding:8px 0;color:#E8EAF2">${providerLabel}</td></tr>
            <tr><td style="padding:8px 0;color:#8B8FA8">Topics explored</td><td style="padding:8px 0;color:#E8EAF2">${topicList}</td></tr>
          </table>
    ...
    html: `
      <div style="font-family:Inter,sans-serif;max-width:520px;margin:0 auto;background:#05060E;color:#E8EAF2;border-radius:12px;overflow:hidden">
        ...
        <div style="padding:24px 28px;font-size:14px;line-height:1.7;color:#C5C8DC">
          ...
          <p style="margin-top:12px">I've already seen your conversation and the topics you were looking into. If you want a real scoped plan for your project, the fastest next step is a <strong style="color:#fff">free 30-minute discovery call</strong> — no pitch, just a technical assessment.</p>
